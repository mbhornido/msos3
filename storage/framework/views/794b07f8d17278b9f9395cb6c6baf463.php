      ...
      <aside class="shop-sidebar">
        ...
        <form id="filter-form">
            ...
            <?php $__currentLoopData = $allDepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departmentItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                <label>
                    <input type="checkbox" class="redirect-checkbox" data-url="<?php echo e(url('seller_departments', $departmentItem->id)); ?>" <?php echo e(request()->is('seller_departments/' . $departmentItem->id) ? 'checked' : ''); ?>>
...
<?php /**PATH C:\xampp\htdocs\msoshub1\resources\views/home/department_admin.blade.php ENDPATH**/ ?>