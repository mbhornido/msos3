...
<!-- 
    <li class="nav-item">
        ...
        <!-- <a href="javascript:void(0);" class="dropdown-item">
            <img src="<?php echo e(asset('img/flags/fr.png')); ?>" alt="" height="16"> French
        </a>
        <a href="javascript:void(0);" class="dropdown-item">
            <img src="<?php echo e(asset('img/flags/es.png')); ?>" alt="" height="16"> Spanish
        </a>
        <a href="javascript:void(0);" class="dropdown-item">
            <img src="<?php echo e(asset('img/flags/de.png')); ?>" alt="" height="16"> German
        </a> -->
    </div>
    </li> 
    ...
    <img src="<?php echo e(asset('img/icons/notification-bing.svg')); ?>"  alt="img"> <span class="badge rounded-pill">4</span>
    </a>
    ...
    <div class="media d-flex">
    <span class="avatar flex-shrink-0">
    <img alt="" src="<?php echo e(asset('img/profiles/avatar-03.jpg')); ?>" >
    </span>
    <div class="media-body flex-grow-1">
    ...
    <div class="media d-flex">
    <span class="avatar flex-shrink-0">
    <img alt="" src="<?php echo e(asset('img/profiles/avatar-06.jpg')); ?>">
    </span>
    <div class="media-body flex-grow-1">
    ...
    <div class="media d-flex">
    <span class="avatar flex-shrink-0">
    <img alt="" src="<?php echo e(asset('img/profiles/avatar-17.jpg')); ?>">
    </span>
    <div class="media-body flex-grow-1">
    ...
    <div class="media d-flex">
    <span class="avatar flex-shrink-0">
    <img alt="" src="<?php echo e(asset('img/profiles/avatar-13.jpg')); ?>">
    </span>
    <div class="media-body flex-grow-1">
    ...
    <span class="user-img">
        ...
        <img src="<?php echo e(asset('logo/' . Auth::user()->logo)); ?>" alt="">
    ...
    <span class="user-img"><img src="<?php echo e(asset('logo/' . $user->logo)); ?>" alt="">
    ...
    <hr class="m-0">
    <a class="dropdown-item" href="<?php echo e(url('profile_edit')); ?>"> <i class="me-2" data-feather="user"></i> My Profile</a>
    <a class="dropdown-item" href="generalsettings.html"><i class="me-2" data-feather="settings"></i>Track Order</a>
    <hr class="m-0">
...
<li>
<a href="<?php echo e(url('profile')); ?>"><i class="fa-solid fa-user"></i><span> Profile</span> </a>
</li>
<li>
<a href="<?php echo e(url('update_password')); ?>"><i class="fa-solid fa-lock"></i>
...
<li><a href="<?php echo e(url('update_password')); ?>">password</a></li>
...
<li class="submenu">
<a href="javascript:void(0);"><img src="<?php echo e(asset('img/icons/purchase1.svg')); ?>" alt="img"><span> Announcements</span> <span class="menu-arrow"></span></a>
<ul>
...
<?php /**PATH C:\xampp\htdocs\msosfinal\msos3\resources\views/includes/user_header.blade.php ENDPATH**/ ?>