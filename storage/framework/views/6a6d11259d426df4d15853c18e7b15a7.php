...
<head>
  ...
  <title>Chat with <?php echo e($user->shop_name); ?></title>
    ...
    <div class="container">
        ...
        <?php if(auth()->user()->usertype !== 'admin'): ?>
            <header class="back_header">
                <a href="<?php echo e(url('view_seller_profile', $user->id)); ?>"><i class="fa-solid fa-arrow-left"></i></a>
                <a href="<?php echo e(url('mycart')); ?>" class="icon1">
                    <i class="fa-solid fa-cart-shopping"></i><span><?php echo e($count); ?></span>
                </a>
            </header>
        ...
        <?php endif; ?>
            ...
            <div class="chat-container">
                <div class="shop-info">
                    ...
                    <div class="chat_data">
                        <img src="<?php echo e(asset('logo/' . $user->logo)); ?>"  alt="">

                        <div class="chat_data_more">
                            <h2><?php echo e($user->shop_name); ?></h2>
                            <p><?php echo e($user->college); ?></p>
                        </div>
                    </div>
                    <br>
                    <hr>
                ...
                <div class="chat-messages-container">
                    <div id="chat-messages">
                        <?php $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="message <?php echo e($chat->sender_id === auth()->id() ? 'sender' : 'receiver'); ?>">
                                <div class="message-content">
                                    <strong><?php echo e($chat->sender->name); ?>:</strong> <?php echo e($chat->message); ?>

                                    <br>
                                    <p><?php echo e($chat->created_at->format('M d, Y h:i A')); ?></p>
                                </div>
                            </div>
...
$(document).ready(function () {
    ...
    $('#chat-form').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo e(route('chat.store', $user->id)); ?>',
            method: 'POST',
            headers: {
...
function fetchMessages() {
    $.ajax({
        url: '<?php echo e(route('chat.show', $user->id)); ?>',
        method: 'GET',
...
<?php /**PATH C:\xampp\htdocs\msosfinal\msos3\resources\views/chat/chat.blade.php ENDPATH**/ ?>