            ...
            <div id="chat-messages">
                <?php $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="message <?php echo e($chat->sender_id === auth()->id() ? 'sender' : 'receiver'); ?>">
                        ...
                        <br>
                        <small><?php echo e($chat->created_at->format('M d, Y h:i A')); ?></small>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        const userEndpoint = '<?php echo e($user->id); ?>'; // Ensure this is available in the Blade context
...
<?php /**PATH C:\xampp\htdocs\msosfinal\msos3\resources\views/admin/admin_chat_user.blade.php ENDPATH**/ ?>