                ...
                <div class="card-bodys">
                    ...
                    <form action="<?php echo e(url('bulk_update_order_status')); ?>" method="POST">
                        ...
                        <div class="bulk-update-options mb-3">
                            ...
                            <a href="<?php echo e(url('orders_delete')); ?>" class="btn btn-danger mb-3"><i class="fa-solid fa-repeat"></i> <i class="fa-solid fa-trash"></i></a>
...
<?php /**PATH C:\xampp\htdocs\msosfinal\msos3\resources\views/admin/orders.blade.php ENDPATH**/ ?>