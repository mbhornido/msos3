...
<!-- 
    ...
    <span class="user-img">
        ...
        <img src="{{ asset('logo/' . Auth::user()->logo) }}" alt="">
    ...
    <span class="user-img"><img src="{{ asset('logo/' . $user->logo) }}" alt="">
    ...
    <hr class="m-0">
    <a class="dropdown-item" href="{{url('profile_edit')}}"> <i class="me-2" data-feather="user"></i> My Profile</a>
...
<li>
<a href="{{url('profile')}}"><i class="fa-solid fa-user"></i><span> Profile</span> </a>
</li>
<li>
<a href="{{url('update_password')}}"><i class="fa-solid fa-lock"></i>
...
<li><a href="{{url('update_password')}}">password</a></li>
