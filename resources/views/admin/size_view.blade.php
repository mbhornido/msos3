        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Product Sizes List</h4>
                    <h6>View Product Sizes</h6>
                </div>
                <div class="page-btn">
                    <a href="{{url('view_size')}}" class="btn btn-added">
                        <img src="{{asset('img/icons/plus.svg')}}" class="me-1" alt="img">Add Sizes
                    </a>
                </div>
            </div>
                            ...
                            <tbody>
                                <tr>
                                    <td class="productimgnames">
                                        <a href="">{{$size_data->size_name}}</a>
                                    </td>
                                    <td>
                                        
                                        <a class="me-3" href="{{url('delete_size',$size_data->id)}}">
