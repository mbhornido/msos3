                ...
                <div class="product-grid">
                    @foreach($products as $products)
                        <div class="product-card">
                            ...
                            <p>Category: {{ $products->category }}</p> <!-- Make sure category relationship exists in Product model -->
                            <p>Price: ₱{{ $products->price }}.00</p>
                            <button class="secondary-button" onclick="window.location.href='{{ url('product_details', $products->id) }}'">View Details</button>
                        </div>
                    @endforeach
                </div>
            </div>
